...
import com.example.restapiproject.accounts.CurrentUser;
...
public class EventController {
    ...
    public ResponseEntity createEvent(@RequestBody @Valid EventDto eventDto,
                                      Errors errors,
                                      @CurrentUser Account currentUser /* @AuthenticationPrincipal(expression = "account") Account account */ ) {
        // 인증 안하고 접근하면 Authentication 객체가 String anonymousUser로 나옴
