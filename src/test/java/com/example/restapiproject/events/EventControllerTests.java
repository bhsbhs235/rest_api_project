...
import com.example.restapiproject.accounts.AccountRepository;
import com.example.restapiproject.accounts.AccountRole;
import com.example.restapiproject.accounts.AccountService;
import com.example.restapiproject.common.AppProperties;
import com.example.restapiproject.common.BaseTest;
...
public class EventControllerTests extends BaseTest {
    ...
    @BeforeEach // Test 각각 실행하기 전에 실행
    // 테스트 간에 인메모리를 공유하기 때문에 키 값이나 토큰이 동일해 Unauthroized 에러가 발생함(전체 실행시, 단위 테스트는 에러발생 안함)
    public void setUp() {
    ...
    private Account createAccount() {
        Account hyoseong = Account.builder()
                .email(appProperties.getUserUsername())
                .password(appProperties.getUserPassword())
                .roles(Set.of(AccountRole.ADMIN, AccountRole.USER))
                .build();
        return this.accountService.saveAccount(hyoseong);
    }
